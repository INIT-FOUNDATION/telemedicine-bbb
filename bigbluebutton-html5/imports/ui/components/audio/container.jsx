...
class AudioContainer extends PureComponent {
  ...
  joinAudio() {
    ...
    const { userSelectedMicrophone, userSelectedListenOnly } = this.props;
...
const webRtcError = _.range(1001, 1011).reduce(
  (acc, value) => ({
    ...acc,
...
export default lockContextContainer(
  withModalMounter(
    injectIntl(
      withTracker(({ mountModal, intl, userLocks }) => {
